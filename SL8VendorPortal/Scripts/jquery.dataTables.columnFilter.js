...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
		...
		function fnCreateCheckbox(oTable, aData, tablo_checkboxes) {
            ...
            for (j = 0; j < iLen; j++) {
                ...
                var tablo_checkboxes_I = tablo_checkboxes; //["Annulé", "En cours"];
                var ckecked = '';
                if (tablo_checkboxes_I != '' && typeof (tablo_checkboxes) != 'undefined' && typeof (tablo_checkboxes_I) != 'undefined') {
                    if (jQuery.inArray(aData[j], tablo_checkboxes_I) >= 0) ckecked = ' checked="checked" '; else ckecked = '';
                }

                //check button
                //r += '<input class="search_init checkbox_filter" type="checkbox" id= "' + aData[j] + '" name= "' + localLabel + '" value="' + aData[j] + '" >' + aData[j] + '<br/>';
                //r += '<label><input class="search_init checkbox_filter" ' + ckecked + ' type="checkbox" id="' + aData[j] + '" name="' + localLabel + '" value="' + aData[j] + '" /> ' + aData[j] + '</label><br/>';
                r += '<input class="search_init checkbox_filter" ' + ckecked + ' type="checkbox" id="' + aData[j] + '" name="' + localLabel + '" value="' + aData[j] + '" /> ' + aData[j] + '<br/>';
                ...
                if (aoColumn != null) {
                    ...
                    switch (aoColumn.type) {
                        ...
                        case "checkbox":
                            ...
                            fnCreateCheckbox(oTable, aoColumn.values, aoColumn.tablo_checkboxes);
                            break;
